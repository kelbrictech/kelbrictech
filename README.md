...
**[Repository](https://github.com/kelbrictech/Bakers-Diary)**
...
|---|---|
| **[RemitCompare](https://github.com/kelbrictech/RemitCompare)** | Live remittance-rate comparison against the mid-market rate |
| **[BudgetFX](https://github.com/kelbrictech/BudgetFX)** | Multi-currency budgeting with persistent local state and live conversion |
| **[RateAlert](https://github.com/kelbrictech/RateAlert)** | Currency monitoring, visual trends, and threshold-based alerts |
...
| Project | What it explores |
|---|---|
| **[OrbitConnect](https://github.com/kelbrictech/OrbitConnect)** | Combined GitHub + npm activity in a unified developer profile |
| **[OrbitOrg](https://github.com/kelbrictech/OrbitOrg)** | Organization repository visualization |
| **[OrbitStats](https://github.com/kelbrictech/OrbitStats)** | Commit activity, languages, and contributor patterns |
| **[Orbit](https://github.com/kelbrictech/Orbit-a-GitHub-profile-explorer)** | Repository-centered GitHub profile exploration |
